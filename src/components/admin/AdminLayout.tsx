      ...
      <div className="flex-1 flex flex-col min-w-0">
        <header className="flex items-center justify-between border-b border-white/5 px-6 lg:px-10 py-4 bg-[#0a0a0a]">
          ...
          <div className="flex items-center gap-6">
            {admin && (
              <a href="/admin/perfil" onClick={(e) => { e.preventDefault(); navigate('/admin/perfil'); }} className="hidden md:flex flex-col items-end hover:bg-white/5 px-3 py-1.5 rounded-lg transition-colors cursor-pointer">
