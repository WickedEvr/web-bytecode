      ...
      <header className="absolute top-0 left-0 right-0 z-50 px-5 pt-16 pb-6 flex items-center justify-center bg-transparent">
        <div className="flex items-center gap-10">
          <Link to="/" className="flex items-center">
            <img src="/designs/logo_en_blanco.svg" alt="Bytecode" className="h-14 w-auto" />
          </Link>
          <button
          ...
          >
            <svg viewBox="0 0 64 36" className="w-10 h-6" fill="none" xmlns="http://www.w3.org/2000/svg">
