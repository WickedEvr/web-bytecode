...
const Condiciones: React.FC = () => {
  ...
  return (
    <div className="relative min-h-screen flex flex-col overflow-hidden font-sansation md:select-none">
      <SEO 
      ...
      <div className="relative z-10 w-full max-w-[950px] md:max-w-[780px] lg:max-w-[1100px] mx-auto px-4 sm:px-6 pt-28 pb-13 md:pt-36 md:pb-15 lg:pt-55.5 lg:pb-32 pointer-events-auto flex-1 flex flex-col justify-center items-center">
        <motion.div
          ...
          className="relative z-10 w-full bg-[#051322]/80 backdrop-blur-sm md:bg-white/[0.03] md:backdrop-blur-xl rounded-[2.5rem] shadow-[0_0_50px_rgba(0,0,0,0.3)] text-white/90"
        >
          {/* Mobile Wrapper (Optimized with solid border) */}
          <div className="md:hidden relative flex flex-col w-full bg-transparent p-8 border-2 border-[#0CA3C6] rounded-[2.5rem]">
            {cardContent}
          </div>
