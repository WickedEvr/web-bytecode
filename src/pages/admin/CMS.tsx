    ...
    <div className="rounded-2xl border border-white/10 bg-white/[0.04] p-5">
      <header className="mb-6 flex items-center justify-between border-b border-white/10 pb-5">
        <div className="flex items-center gap-3">
          <LayoutTemplate className="h-6 w-6 text-[#06CFD6]" />
          <div>
            <h2 className="text-xl font-bold text-white">CMS y Contenido</h2>
            <p className="text-sm text-white/60">Gestión de páginas, bloques y banners.</p>
          </div>
        </div>
      ...
      <div className="flex h-[360px] flex-col items-center justify-center text-center text-white/50">
        Módulo de CMS dinámico en construcción...
      </div>
    </div>
  );
};
