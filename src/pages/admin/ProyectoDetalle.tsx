...
const ProyectoDetalle: React.FC = () => {
  ...
  const getMilestoneAmountString = (milestone: ProjectMilestone) => {
    ...
    if (!amount) return '';
    const calculated = (amount * Number(milestone.payment_percentage)) / 100;
    return `(${formatCurrencyValue(calculated, currency)})`;
  };
