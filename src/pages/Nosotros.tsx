    ...
    <div className="relative flex w-full flex-col overflow-x-clip bg-[#044553] font-sansation select-none">
      ...
      <section className="relative w-full lg:pb-[100px] 2xl:pb-[150px]">
        ...
        <div className="relative z-10 flex flex-col lg:block w-full lg:overflow-visible bg-[#0CA3C6] lg:bg-transparent px-4 sm:px-6 lg:px-[80px] xl:px-12 2xl:px-[100px] pb-16 sm:pb-20 lg:pb-0 pt-5 sm:pt-8 lg:pt-[140px] xl:pt-[200px] 2xl:pt-[250px] mx-auto max-w-none lg:max-w-[1600px] lg:min-h-[1050px] xl:min-h-[1350px] 2xl:min-h-[1600px] transition-all duration-500">
          ...
          <div className="pointer-events-none absolute inset-0 z-0 opacity-80 top-[225px] lg:hidden">
            <img src="/designs/elemento_intermedio_nosotros_vista_movil.svg" alt="Patrón" className="h-[434px] w-[648px] object-cover object-left-top" />
          </div>
          ...
          <div className="relative z-30 w-full lg:w-1/2 lg:pl-[30px] flex flex-col order-2 lg:order-none">
            ...
            <div className="absolute lg:relative -top-[750px] md:-top-[750px] sm:-top-[140px] lg:top-0 left-0 lg:left-auto w-full lg:w-auto px-5 sm:px-8 lg:px-0 text-center lg:text-left z-20 lg:z-auto">
              <motion.h1
                ...
                viewport={{ once: true }}
                className="font-bold text-[#0CA3C6] leading-none lg:leading-tight text-[clamp(2rem,8.5vw,3.2rem)] lg:text-[65px] xl:text-[75px] 2xl:text-[85px] lg:mb-6 transition-all"
              >
                Nosotros
              </motion.h1>
              ...
              <motion.p
                ...
                className="mx-auto lg:mx-0 mt-3 sm:mt-4 lg:mt-0 max-w-[19rem] sm:max-w-[24rem] lg:max-w-[1600px] text-[0.9rem] sm:text-[1rem] lg:text-[22px] xl:text-[26px] 2xl:text-[32px] leading-[1.05rem] sm:leading-[1.2rem] lg:leading-snug 2xl:leading-[36px] text-white/90 lg:text-white lg:text-justify lg:mb-[70px] xl:mb-[100px] 2xl:mb-[150px] transition-all"
              >
            ...
            <div className="relative z-10 flex flex-col items-center lg:items-start text-center lg:text-left gap-11 sm:gap-14 lg:gap-[50px] xl:gap-[80px] 2xl:gap-[120px] max-w-[20rem] sm:max-w-[24rem] lg:max-w-none mx-auto lg:mx-0 mt-[250px] sm:mt-0 lg:mt-[100px] xl:mt-[220px] 2xl:mt-[250px] mb-[250px] sm:mb-[250px] lg:mb-0 lg:pl-20 transition-all duration-500">
              {infoBlocks.map((block, index) => (
                <motion.div key={block.title} initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ delay: index * 0.1 }} className="flex flex-col items-center lg:items-start">
                  ...
                  <p className="mt-4 lg:mt-0 max-w-[18rem] sm:max-w-[22rem] lg:max-w-[550px] text-[0.95rem] sm:text-[1rem] lg:text-[18px] xl:text-[20px] 2xl:text-[24px] leading-[1.2rem] sm:leading-[1.35rem] lg:leading-relaxed text-white/85 lg:text-white lg:text-justify transition-all">
                    {block.text}
                  </p>
                </motion.div>
              ))}
          ...
          <div className="relative lg:absolute z-10 lg:z-20 w-full lg:w-[800px] max-w-[18rem] sm:max-w-[21rem] lg:max-w-none mx-auto lg:mx-0 mb-24 sm:mb-14 lg:mb-0 aspect-[0.72] lg:aspect-auto lg:right-0 lg:top-[55px] lg:h-[1700px] lg:origin-[100%_15%] lg:scale-[0.62] xl:scale-[0.82] 2xl:scale-[1.21] 2xl:-right-34 pointer-events-none lg:transition-transform lg:duration-500 order-1 lg:order-none mt-[20px] lg:mt-0">
            ...
            <motion.div initial={{ opacity: 0, x: -60, y: 60 }} whileInView={{ opacity: 1, x: 0, y: 0 }} viewport={{ once: true }} transition={{ duration: 0.8, delay: 0.2, ease: "easeOut" }} className="absolute top-[336px] lg:top-[1029px] right-[calc(100%-164.2px)] lg:right-auto lg:left-[80px] h-[149px] lg:h-[403px] w-[100vw] lg:w-[414px] rounded-r-[34px] lg:rounded-[59px] rounded-l-none lg:rounded-l-[59px] bg-[#026B9B]" />
      ...
      <div className="pointer-events-none absolute bottom-0 left-0 right-0 z-10 h-[950px] w-full lg:hidden">
        <img src="/designs/elemento_final_nosotros_vista_movil.svg" alt="Fondo Móvil" className="h-full w-full object-cover object-bottom" />
      </div>
